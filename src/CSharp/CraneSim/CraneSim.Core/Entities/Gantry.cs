...
namespace CraneSim.Core.Entities
{
    public class Gantry
    {
        ...
        public float MaxPosZ { get; set; } = 0.0F;
        ...
        public float AccelAndDecelTime { get; set; } = 0.0F;

        public double Height { get; set; } = 0.0F;
        public double Width { get; set; } = 0.0F;
        public double Length { get; set; } = 0.0F;

        public float MinimumSpeedValue { get; set; } = 0.0F;
        public float MaximumSpeedValue { get; set; } = 0.0F;
        public float MinimumAccelerationValue { get; set; } = 0.0F;
        public float MaximumAccelerationValue { get; set; } = 0.0F;
